...
{
    /// <inheritdoc />
    public partial class AddPurchaseOrdersAndSuppliers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Lead = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResponsivenessRating = table.Column<int>(type: "int", nullable: false),
                    OnTime = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ActualLeadDays = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryEvaluations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeliveryEvaluations_PurchaseOrders_PurchaseOrderId",
                        column: x => x.PurchaseOrderId,
                        principalTable: "PurchaseOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeliveryEvaluations_Users_RatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    DeliveryEvaluationId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryPhotos_DeliveryEvaluations_DeliveryEvaluationId",
                        column: x => x.DeliveryEvaluationId,
                        principalTable: "DeliveryEvaluations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryEvaluations_PurchaseOrderId",
                table: "DeliveryEvaluations",
                column: "PurchaseOrderId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryEvaluations_RatedByUserId",
                table: "DeliveryEvaluations",
                column: "RatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryPhotos_DeliveryEvaluationId",
                table: "DeliveryPhotos",
                column: "DeliveryEvaluationId");
