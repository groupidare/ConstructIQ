  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Algorithm-generated reorder recommendations using ROP, TSL, and Dynamic Lead Time.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        {projects.map(p => (
          <Link key={p.id} href={`/procurement/${p.id}`}>
